...
model VolumeNodeWH_Test
  ...
  VolumeNodeWH volumeNodeWH annotation(
...
equation
  ...
  connect(boundary_in.ports[1], volumeNodeWH.Input) annotation(
    Line(points = {{-60, 0}, {-10, 0}}, color = {0, 127, 255}));
  connect(volumeNodeWH.Output, boundary_out.ports[1]) annotation(
