...
model GasSideHE2D_Test
  ...
  TPPSim02.HeatExchanger.GasSideHE2D gasSideHE(gasMassDynamics = TPPSim02.Choices.Dynamics.SteadyState, gasMomentumDynamics = TPPSim02.Choices.Dynamics.SteadyState, numberOfTubeSections = numberOfTubeSections) annotation(
