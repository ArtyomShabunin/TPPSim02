...
model VolumeNode2_Test
  ...
  TPPSim02.Pipes.VolumeNode2 volumeNode2(nPorts = 2)  annotation(
...
equation
  ...
  connect(boundary_out.ports[1], volumeNode2.Port[1]) annotation(
    Line(points = {{60, 0}, {0, 0}}, color = {0, 127, 255}));
  connect(volumeNode2.Port[2], boundary_in.ports[1]) annotation(
    Line(points = {{0, 0}, {-60, 0}}, color = {0, 127, 255}));
annotation(
    experiment(StartTime = 0, StopTime = 1, Tolerance = 1e-6, Interval = 0.002));
end VolumeNode2_Test;
