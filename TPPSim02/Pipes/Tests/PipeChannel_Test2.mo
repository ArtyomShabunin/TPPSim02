...
model PipeChannel_Test2
  ...
  Modelica.Fluid.Sources.FixedBoundary boundary_out(redeclare package Medium = Medium, T = 50 + 273.15, nPorts = 1) annotation(
    Placement(visible = true, transformation(origin = {90, 0}, extent = {{10, -10}, {-10, 10}}, rotation = 0)));
  TPPSim02.Pipes.HeatingNodesChannel pipe(numberOfVolumes = 10) annotation(
    Placement(visible = true, transformation(origin = {0, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Thermal.HeatTransfer.Sources.FixedTemperature[10+1] fixedTemperature(each T = 100 + 273.15) annotation(
