...
model HeatingNodesChannel2
  ...
  TPPSim02.Pipes.VolumeNodeWH[numberOfVolumes] node(each deltaVFlow = pi * Din ^ 2 * n_parallel * Lpipe / numberOfVolumes / 4,
  ...
  TPPSim02.Pipes.FlowNodeHeated[numberOfVolumes+1] channel(each Din = Din,
